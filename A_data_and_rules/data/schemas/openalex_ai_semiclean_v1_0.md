...
One row per journal article. Produced by `A_data_and_rules/OpenAlex_AI_Dataset_v1_0.ipynb` (dataset v1.0, frozen 2026-08-01): non-retracted articles 2015-2024 from the frozen population of 64 journals whose primary OpenAlex topic is in the frozen list of 49 AI topics. 27,400 rows. The raw source is `openalex_ai_raw_v1_0.jsonl` (not in git, shared via Teams/OneDrive).
