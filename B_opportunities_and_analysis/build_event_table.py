...
CORPUS = os.path.join(ROOT, "A_data_and_rules", "data", "openalex_ai_semiclean_v1_0.csv")
PUBLISHERS = os.path.join(ROOT, "A_data_and_rules", "results", "openalex_three_path_v1_0", "journal_parent_publishers.csv")
FLAGS = os.path.join(ROOT, "A_data_and_rules", "results", "openalex_three_path_v1_0", "pathway_flags.csv")
OUT_A = os.path.join(ROOT, "B_opportunities_and_analysis", "data", "event_table_python_v0_oppA.csv")
OUT_B = os.path.join(ROOT, "B_opportunities_and_analysis", "data", "event_table_python_v0_oppB.csv")
