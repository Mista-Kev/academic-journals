...
- Python build: `B_opportunities_and_analysis/build_event_table.py`, output `data/event_table_python_v0_oppA.csv`
  sha256 `76f5ed2b37a4f683ac4c754e195417e65352155f3bcc4349f626252e34b6a041`
- Prolog build: `A_data_and_rules/logic/event_table_rules.pl` via `A_data_and_rules/logic/check_event_table_parity.py`,
