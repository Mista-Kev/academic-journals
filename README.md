...
**Plan:** the single overview — metrics, ordered tasks with owners and dependencies, parallel tracks, milestones, open decisions — is [docs/plan.md](docs/plan.md).
...
**How we work:** coordination is asynchronous through issues rather than fixed meetings — decisions are recorded in the repo, in [docs/decisions.md](docs/decisions.md). New to git/GitHub? Step-by-step: [docs/github-guide.md](docs/github-guide.md).
